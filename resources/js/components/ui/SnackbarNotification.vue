<template>
    <transition name="bounce-slide">
        ...
        >
            <div
                class="alert shadow-lg flex items-center justify-between p-4 rounded-lg border bg-base-100 border-neutral-content"
            >
                <div class="flex-1 text-base-content">
                    <p class="font-medium">{{ message }}</p>
                </div>
                <button
                    class="btn btn-sm btn-circle btn-ghost ml-4 text-base-content hover:text-primary"
                    @click="hide"
                >
